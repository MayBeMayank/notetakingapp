# Spec: user-auth
_Permanent capability record. First introduced by AB-1002._

---

## Purpose

Defines the authentication capabilities of the note-taking API: account registration, credential-based login, refresh token rotation, logout/revocation, and the JWT middleware that enforces authentication on protected routes.
