# Delta Spec — share-ui (AB-1014)

Consumes: `POST /api/notes/:id/shares`, `GET /api/shares`, `DELETE /api/shares/:id` (AB-1008, SDS §6.6)
FRS coverage: §7.1, §7.2, §7.4, §7.5, §7.6 (create-side), §7.7
