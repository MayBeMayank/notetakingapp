...
Establishes `packages/shared` as the single authoritative source for all
cross-cutting Zod schemas and TypeScript types. This ticket creates the
directory structure and barrel exports; schema content is deferred to feature
tickets (AB-1002+).

References: SDS §1 (shared-package rule), AGENTS.md §12.
