...
- [x] **1.1 [PARALLEL]** `frontend/src/features/share/expiryPresets.ts`
...
- [x] **1.2 [PARALLEL]** `frontend/src/features/share/shareUrl.ts`
  - `toAbsoluteShareUrl(relativeUrl: string): string` — prepend `window.location.origin`
- [x] **1.3 [PARALLEL]** `frontend/src/api/shares.ts`
...
- [x] **2.1 [PARALLEL]** `frontend/src/features/share/ShareLinkRow.tsx`
...
- [x] **2.2 [PARALLEL]** `frontend/src/features/share/CreateShareForm.tsx`
...
- [x] **2.3 [PARALLEL]** `frontend/src/features/share/PublicNoteView.tsx`
...
- [x] **2.4** `frontend/src/features/share/ShareModal.tsx` — depends on 2.1, 2.2
...
- [x] **2.5** `frontend/src/features/share/ShareButton.tsx` — depends on 2.4
  - Local open state; renders trigger `<Button>` + `<ShareModal noteId open onClose />`
- [x] **2.6** `frontend/src/pages/PublicSharePage.tsx` — depends on 2.3 + 1.3
...
- [x] **3.1 [PARALLEL]** `frontend/src/App.tsx`
...
- [x] **3.2 [PARALLEL]** `frontend/src/features/notes/NoteEditor.tsx`
  - Add `<ShareButton noteId={note.id} />` to the header row (beside `SaveStatusIndicator`)
- [x] **3.3 [PARALLEL]** `frontend/src/features/notes/NoteCard.tsx`
...
- [x] **4.1 [PARALLEL]** `frontend/src/features/share/expiryPresets.test.ts`
  - `never → null` · `'7d' → future ISO ~ now+7d`
- [x] **4.2 [PARALLEL]** `frontend/src/features/share/shareUrl.test.ts`
  - `/s/abc → origin + /s/abc` (Copy a link URL → copy succeeds)
- [x] **4.3 [PARALLEL]** `frontend/src/api/shares.test.tsx`
...
- [x] **4.4 [PARALLEL]** `frontend/src/features/share/ShareModal.test.tsx`
...
- [x] **4.5 [PARALLEL]** `frontend/src/features/share/ShareLinkRow.test.tsx`
...
- [x] **5.1** Playwright journey: log in → open a note → Share → generate link →
