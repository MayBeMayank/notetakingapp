...
Establishes the pnpm workspace monorepo with TypeScript strict-mode
configuration, ESLint linting, Husky pre-commit hooks, commitlint enforcement,
an Express 5 backend skeleton, and a Vite/React 19 frontend skeleton.

References: SDS §1 (architecture), SDS §2 (tech stack).
