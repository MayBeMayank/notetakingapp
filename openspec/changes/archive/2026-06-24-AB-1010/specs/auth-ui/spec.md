# Spec: auth-ui
_Capability introduced by AB-1010_

All screens validate input with the shared Zod schemas from `@note-app/shared/schemas/auth` (`RegisterSchema`, `LoginSchema`, `ForgotPasswordSchema`, `ResetPasswordSchema`) — no shape is redefined in the frontend.
